...
public class Main {
    ...
    public void cetakData() {
        ...
        for(int i = 0 ;i < dataMasiswa.size();i++){
            ...
            System.out.println((i+1)+"\t"+dataMasiswa.get(i).nim+"\t"+dataMasiswa.get(i).name+"\t\t"+dataMasiswa.get(i).jurusan+"\t\t"+dataMasiswa.get(i).
            tahun_lahir+"\t\t"+dataMasiswa.get(i).Jenis_Kelamin);
